...
public class AdminController {
    ...
    public String delStudent(@RequestParam String id, HttpServletRequest req) throws InterruptedException {
...
//    @ResponseBody
//    public Msg delStudent(@RequestParam String id, HttpServletRequest req) {
//        System.out.println(id);
//        System.out.println("删除阶段");
//        adminService.delStudent(id);
