...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">学生选修课管理系统</a>
        </div>
...
<div class="container">
    <form action="/addCourse" method="post" id="course_change">
        <h3>新课程信息</h3>
        ...
        <div class="form-group has-error">
            ...
            <input type="text" class="form-control" id="time" name="time" placeholder="上课时间" required>
        </div>
        <div class="form-group has-error">
        ...
        <div class="form-group has-error">
            ...
            <textarea rows="5" type="text" class="form-control" id="detail" name="detail" placeholder="课程描述" value="" required></textarea>
        </div>
        <button id="submit_btn" type="submit" disabled="disabled" class="btn btn-success">提交</button>
